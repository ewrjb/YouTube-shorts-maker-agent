...
class SceneOutput(BaseModel):
    ...
    embedded_text: str = Field(description="Text overlay for the image (can be any case/style)")
    embedded_text_location: str = Field(description="Where to position the text on the image (e.g.., 'top center', 'bottom left', 'middle right', 'center')")
